      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Column(
            ...
            children: [
              Text('GlowWhisk',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 16),),
          ...
          child: Column(
            ...
            InkWell(
               ...
               ListTile(
                ...
                onTap: () {
                 ...
                 child: ListTile(
                  ...
                  title: Text('Tips',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 14),),
                             ),
               ), 
                InkWell(
                onTap: () {
              ...
              ListTile(
               ...
               ListTile(
                leading:  Icon(IconlyBold.buy,color:appcolor,),
                title: const Text('Orders',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 14),),
                onTap: () {
